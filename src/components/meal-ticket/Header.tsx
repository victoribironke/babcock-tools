  ...
  return (
    <header className="w-full flex flex-wrap gap-2 items-center justify-center bg-blue p-4 hadow-md rounded-xl">
      <Link
        ...
        className="flex hover:bg-white hover:text-blue text-white py-1 px-3 rounded-md w-fit rs:mr-auto"
      >
        How does it work?
      </Link>
      ...
      <Link
        ...
        className="flex hover:bg-white hover:text-blue text-white py-1 px-3 rounded-md w-fit"
      >
        Sell a ticket
      </Link>
